...
- `적용` 버튼 클릭 시 연결 설정 창이 열립니다.  
  ...
  - **IP 주소 선택 시**: 해당 VPC 내 접근 가능한 IPv4 주소를 직접 입력합니다. (예: `172.31.1.4`)
...
| **외부 IP 주소**  | 자동 / 수동                       | 수동 선택 시 외부 IP 주소 지정 필수 | 필수                     |
...
| **VPC**   | 연결된 리소스가 없는 경우, VPC를 변경할 수 있습니다.                                      |
| **외부 IP** | 연결된 리소스가 없는 경우, 외부 IP를 변경할 수 있습니다. 종속된 프로젝트의 미사용 외부 IP 중에 선택할 수 있습니다. |
