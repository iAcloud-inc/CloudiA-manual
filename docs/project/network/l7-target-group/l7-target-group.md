...
### 네트워크 보안 정책
Cloudia L4/L7 로드 밸런서는 로드 밸런서와 타겟이 서로 다른 서브넷에 위치해도 NACL을 적용받지 않습니다. 따라서 타겟 그룹 사용 전제 조건에서 NACL은 검토 대상이 아니며, 타겟 서버에 연결된 [`보안그룹`](../../security/security-group/security-group.md)에서 `클라이언트 -> 타겟` 트래픽을 허용하는 정책을 수립합니다.
...
## 타겟 그룹 생성
### 화면 예시
![어플리케이션 타겟 그룹 생성](./images/l7-target-group-create-l7.png)
...
| **연속 성공 횟수** | 정상으로 전환하기 위해 필요한 연속 성공 횟수입니다. |
| **연속 실패 횟수** | 비정상으로 전환하기 위해 필요한 연속 실패 횟수입니다. |
...
## 타겟 그룹 목록
### 화면 예시
![어플리케이션 타겟 그룹 목록](./images/l7-target-group-list.png)
...
![어플리케이션 타겟 그룹 상세 - 기본 및 정책 정보](./images/l7-target-group-detail-demo-tg-1-basic-policy.png)
...
![어플리케이션 타겟 그룹 상세 - 상태 검사 설정](./images/l7-target-group-detail-demo-tg-1-health-check.png)
...
![어플리케이션 타겟 그룹 상세 - demo-tg-1 타겟 목록](./images/l7-target-group-detail-demo-tg-1-targets.png)

![어플리케이션 타겟 그룹 상세 - demo-tg-2 타겟 목록](./images/l7-target-group-detail-demo-tg-2-targets.png)
...
![어플리케이션 타겟 그룹 상세 - 연결된 로드 밸런서](./images/l7-target-group-detail-demo-tg-1-load-balancer.png)
...
![어플리케이션 타겟 그룹 타겟 모니터링 정보](./images/l7-target-group-target-monitoring-info.png)
