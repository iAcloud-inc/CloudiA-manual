...
> ⚠️ **주의:** **서브넷 이름, VPC, CIDR, DNS 서버는 한번 생성하면 변경할 수 없습니다.** 신중하게 입력하고 생성해야 합니다. 편집 모드에서는 **타입**과 **설명**만 수정 가능합니다.
