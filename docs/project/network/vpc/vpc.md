...
| **IP/CIDR**  | 서브넷의 IP 주소 범위입니다. (예: `10.0.1.0/24`)                               |
| **주소 사용 현황** | 사용 중인 IP 수와 서브넷의 전체 IP 수  (예: `5 / 256`)                           |
| **설명**       | 서브넷에 대한 설명입니다.                                                     |
...
> ⚠️ **주의:**
> - 하위 서브넷이 이미 존재하는 경우 CIDR은 더 큰 범위로만 확장할 수 있습니다.
> - IP/CIDR의 IP가 네트워크 주소가 아니면 편집 시 네트워크 주소로 자동 보정됩니다.
...
3. 서브넷을 삭제합니다.
4. 마지막으로 VPC를 삭제합니다. 이 때 해당 VPC에 속한 네트워크 접근 제어, 보안그룹, 타겟 그룹의 경우 같이 삭제됩니다.
