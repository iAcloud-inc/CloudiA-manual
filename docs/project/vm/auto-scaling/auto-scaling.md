...
- `재개`: 선택한 오토 스케일링 그룹의 자동 용량 조정을 재개합니다. `일시 중지` 상태이면서 자동 용량 조정이 중지된 오토 스케일링 그룹에 대해서만 활성화됩니다.
- `일시 중지`: 선택한 오토 스케일링 그룹의 자동 용량 조정을 일시 중지합니다. `업데이트 중` 상태이거나, `실행 중`·`스케일 인`·`스케일 아웃` 상태이면서 자동 용량 조정이 활성인 오토 스케일링 그룹에 대해서 활성화됩니다. `업데이트 중`(재배포 등으로 고착된 경우 포함) 상태에서는 자동 용량 조정과 무관하게 활성화됩니다.
