# 블록
**블록** 기능은 블록 스토리지를 생성·관리할 수 있는 인터페이스입니다.  
...
- **이름**: 블록의 이름을 나타냅니다.
- **ID**: 블록의 ID를 나타냅니다.
- **부팅가능여부**: 블록을 OS 디스크로서 사용 가능한지에 대한 여부를 나타냅니다. (`가능` / `불가능`)
- **타입**: 블록의 실제 타입을 나타냅니다.
- **크기**: 블록의 디스크 크기를 나타냅니다.
- **스토리지 도메인**: 블록이 사용중인 스토리지 도메인을 나타냅니다.
...
| **스토리지 도메인** | 사전 정의된 스토리지 도메인 목록 | - | 필수 |
| **크기** | 숫자                 | 최소 단위 0 | 필수 |
| **크기 단위** | MiB, GiB           | - | 필수 |
| **설명** | 200자 이내            | - | 선택 |
...
- 이름, 크기, 크기 단위, 설명만 수정 가능합니다. (스토리지 도메인 편집 불가)
