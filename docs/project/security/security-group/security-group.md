...
| 필드 | 허용 값 | 검증 규칙                                      | 비고 |
| --- | --- |--------------------------------------------| --- |
| **이름** | 영문, 숫자, `-`, `_` 조합의 문자열 | 필수입니다. 80자 이내로 입력합니다. 프로젝트 내에서 중복될 수 없습니다. | 보안그룹 식별용 이름입니다. |
...
목록에서 항목을 선택한 뒤 `규칙 정보`를 확인하고, 필요한 항목을 여러 개 가져올 수 있습니다.
...
| 필드 | 허용 값 | 검증 규칙 | 비고 |
| --- | --- | --- | --- |
| **이름** | 영문, 숫자, `-`, `_` 조합의 문자열 | 필수입니다. 80자 이내로 입력합니다. 프로젝트 내에서 중복될 수 없습니다.| 편집 가능합니다. |
