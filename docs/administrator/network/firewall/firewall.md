...
## 웹콘솔 접근 설정
방화벽 화면에서는 방화벽 규칙과 별도로 **웹콘솔 접근 설정**을 관리할 수 있습니다. 여기서 설정한 **소스 CIDR** 대역의 트래픽은 방화벽 규칙과 무관하게 항상 Cloud:iA 웹콘솔에 접근할 수 있습니다.

- 방화벽 목록 화면에서는 현재 적용 중인 웹콘솔 접근 소스 CIDR을 카드 형태로 확인할 수 있습니다.
- 방화벽 규칙 편집 화면에서는 웹콘솔 접근 소스 CIDR을 직접 입력하고 저장할 수 있습니다.

| 필드            | 허용 값                                                  | 검증 규칙                                                                | 비고                                          |
| ----------------|----------------------------------------------------------| -------------------------------------------------------------------------|---------------------------------------------|
| **소스 CIDR**  | IPv4 CIDR <br/>예: `0.0.0.0/0`, `203.0.113.0/24`         | (필수) 유효한 IPv4 CIDR 형식이어야 함 <br/> `0.0.0.0/0`은 모든 IP 대역을 의미 | 웹콘솔 접근을 허용할 출발지 IP 대역             |

> 💡 **참고:** 웹콘솔 접근 설정은 방화벽 규칙보다 우선하므로, 소스 CIDR을 좁게 지정할수록 웹콘솔 접근 출발지를 더 제한할 수 있습니다. 모든 IP의 접근을 허용하려면 `0.0.0.0/0`을 입력합니다.
