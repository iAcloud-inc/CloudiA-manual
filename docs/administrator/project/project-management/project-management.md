...
### 하단 요약 
- 프로젝트에 할당된 멤버와 각 멤버의 역할을 조회 및 편집하는 기능입니다.
- 상단 도구 모음의  **`편집`** 버튼을 클릭하여 프로젝트 멤버 편집 화면에서 프로젝트 별 멤버 역할 등록이 가능합니다.
...
- 상단 도구 모음의  **`편집`** 버튼을 클릭하여 프로젝트 멤버 편집 화면에서 프로젝트 별 멤버 역할 등록이 가능합니다.
-  **`역할 추가`** 버튼을 클릭하여 맴버별 역할을 추가하거나 **`삭제`** 버튼을 클릭하여 맴버별 역할을 삭제 할 수 있습니다.
...
> ⚠️ **주의:** 시스템 기본 역할중 하나인 `admin` 역할의 경우 역할 추가가 불가능합니다.
