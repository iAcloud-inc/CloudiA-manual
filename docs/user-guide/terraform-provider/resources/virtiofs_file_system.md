...
- [../README.md](../README.md)
- [cloudia_file_system (데이터소스)](../data-sources/file_system.md) — 기존 파일시스템 정보 조회
- [cloudia_storage_domains (데이터소스)](../data-sources/storage_domains.md) — VIRTIOFS 생성 대상 스토리지 도메인 목록 조회

---

> 전체 필드/속성 표는 영문 레퍼런스 문서(provider `docs/resources/virtiofs_file_system.md`)를 기준으로 합니다. 본 페이지는 한국어 사용 예제와 운영 노트를 다룹니다.
