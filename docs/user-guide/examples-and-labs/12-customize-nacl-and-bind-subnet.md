...
이 문서는 커스텀 네트워크 접근 제어를 생성하고 규칙을 추가한 뒤 서브넷을 연결해 트래픽을 제어하는 실습입니다.
...
### 확인
- 네트워크 접근 제어 목록에 커스텀 네트워크 접근 제어가 생성됩니다.
...
### 절차
1. 네트워크 접근 제어 상세 `연결된 서브넷` 탭에서 `연결`을 클릭합니다.
