...
| 항목 | 값 |
|---|---|
| 인바운드 규칙1 | `TCP / 203.0.113.0/24 / 22 / ssh-admin` |
...
| SSH 테스트 | `ssh example-user@203.0.113.70` |
| 앱 포트 테스트 | `curl http://10.0.2.41:8080` |
| 차단 포트 테스트 | `nc -vz 10.0.2.41 3306` |
